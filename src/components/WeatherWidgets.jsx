      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-sm font-medium text-gray-500"><i className="fa-solid fa-location-dot mr-1 text-green-deep"></i>СНТ Алмаз</span>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100"
        >
          <h3 className="text-sm font-medium text-gray-500 mb-3"><i className="fa-solid fa-water mr-1 text-green-deep"></i>Температура воды</h3>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100"
        >
          <h3 className="text-sm font-medium text-gray-500 mb-3"><i className="fa-solid fa-seedling mr-1 text-green-deep"></i>Пыльца</h3>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100"
        >
          <h3 className="text-sm font-medium text-gray-500 mb-3"><i className="fa-solid fa-calendar-check mr-1 text-green-deep"></i>Сезон</h3>
          <ul className="space-y-2">
            {seasonWorks.map((s, i) => (
