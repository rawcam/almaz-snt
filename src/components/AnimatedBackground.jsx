...
export default function AnimatedBackground() {
  ...
  return (
    <div className="parallax-scene" style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: -1, pointerEvents: 'none' }}>
      ...
      {/* Горизонт – все наземные объекты позиционируются относительно сцены */}
      ...
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
        <i className="fa-solid fa-cloud" style={{ position: 'absolute', top: '18%', left: '-10%', fontSize: '3rem', color: 'white', opacity: 0.9, textShadow: '0 2px 8px rgba(0,0,0,0.05)', animation: 'cloudDrift1 40s linear infinite' }} />
        <i className="fa-solid fa-cloud" style={{ position: 'absolute', top: '30%', left: '-15%', fontSize: '3rem', color: 'white', opacity: 0.9, textShadow: '0 2px 8px rgba(0,0,0,0.05)', animation: 'cloudDrift2 50s linear infinite' }} />
        <i className="fa-solid fa-cloud" style={{ position: 'absolute', top: '14%', left: '-20%', fontSize: '3rem', color: 'white', opacity: 0.9, textShadow: '0 2px 8px rgba(0,0,0,0.05)', animation: 'cloudDrift3 45s linear infinite' }} />
      </div>
